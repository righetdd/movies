        ...
        <div className="flex justify-between card p-2 items-center">
          ...
          <div>
            <h1 className="text-sm">
              {moment(show.date).format("DD/MM/DDDD")} -{" "}
              {moment(show.time, "HH:mm").format("HH:mm")}
            </h1>
          </div>
        </div>
        ...
        {selectedSeats.length > 0 && (
          <div className="mt-2 flex justify-center gap-2 items-center flex-col">
            ...
            <StripeCheckout
              ...
              billingAddress
              stripeKey="pk_test_51LxVXHEXShFR2uLnxwhjnfvrVDCMzivu3v90Zrq3X2oZ3m1rn31Bh7gXEIVNNxmF25sNwTyMheDjEV6L2qLcoK7100MQGh0kYT"
