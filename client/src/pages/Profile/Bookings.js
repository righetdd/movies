          ...
          <Col span={12}>
            <div className="card p-2 flex justify-between uppercase">
              <div>
                ...
                <h1 className="text-sm">
                  Date & Time: {moment(booking.show.date).format("DD/MM/YYYY")}{" "}
                  - {moment(booking.show.time, "HH:mm").format("HH:mm")}
                </h1>

                <h1 className="text-sm">
                  Amount : CHF {booking.show.ticketPrice * booking.seats.length} .-
                </h1>
